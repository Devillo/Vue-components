...
<script>
   ...
   * BUTTON_PRESS: 按钮按压样式
   **/
  const BUTTON_CLASS = PREFIX_CLASS + 'raised-btn'
  ...
  const BUTTON_ACTIVE = BUTTON_CLASS + '-active'
      ...
      btnClasses: function() {
        return [this.className,
                this.classNames.btnClass,
                {
                  ...
                  [this.classNames.btnActive]: this.active,
...
<style lang="less" scoped>
  ...
  .@{prefix}raised-btn {
    ...
    box-shadow: rgba(0, 0, 0, 0.11) 0px 1px 6px, rgba(0, 0, 0, 0.11) 0px 1px 4px;
    ...
    &-press .@{prefix}raised-btn-ripples {
    ...
    &-primary {
      ...
      & .@{prefix}raised-btn-name-p {
        color: #fff;
      }

      &.@{prefix}raised-btn-press .@{prefix}raised-btn-ripples {
        background-color: rgba(255, 255, 255, .4);
      }

      & .@{prefix}raised-btn-ripple {
